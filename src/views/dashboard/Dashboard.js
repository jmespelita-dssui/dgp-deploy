...
const Dashboard = () => {
  ...
  const columns = [
    ...
    { key: 'prat_no', label: 'Prat. No.' },
    {
      key: 'title',
      label: 'Title',
    },
    { key: 'categoria', label: 'Category' },
    { key: 'superiori_invitati', label: 'Superiori Invitati' },
    'responsabile',
    { key: 'deadline' },
  ]
  ...
  return (
    <>
      <Pratica visible={visible} onClose={onClosePratica} pratica={selectedPratica} />
        ...
        <CCardBody>
          <CSmartTable
            ...
            scopedColumns={{
              ...
              deadline: (item) => {
                let testDate = moment(item.deadline, 'DD/MM/YYYY')
                let today = moment()
