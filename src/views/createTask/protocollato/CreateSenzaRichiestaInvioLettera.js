...
const CreateSenzaRichiestaInvioLettera = ({ superiors, responsibles }) => {
  return (
    <>
      <CForm className="row p-3">
        ...
        <CRow className="mb-3">
          <CCol md={4}>
            <CFormInput id="ente-ricevente" label="Ente ricevente" />
          </CCol>
        </CRow>
        <CRow className="mb-5">
          <CCol md={4}>
...
export default CreateSenzaRichiestaInvioLettera
